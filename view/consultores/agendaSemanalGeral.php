...
echo "<div class=\"btn-toolbar\" role=\"toolbar\" aria-label=\"\">";
    ...
    echo "</div>";
    echo "<div class=\"btn-group\" role=\"group\" aria-label=\"...\">";
        echo "<button type=\"button\" class=\"btn btn-default\" onclick=\"location.href='../../controller/controleAlocacao.php?operacao=imprimir&data=$day/$month/$year&semana=$semana'\">Imprimir Agenda</button>";
    echo "</div>";
echo "</div>";
